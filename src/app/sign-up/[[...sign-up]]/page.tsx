    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto grid min-h-[calc(100vh-73px)] w-full max-w-7xl items-center gap-8 px-5 py-10 lg:grid-cols-[minmax(0,1fr)_420px]">
        <div className="max-w-xl">
          <p className="text-sm font-medium text-emerald-700">Unlock full exports</p>
          <h1 className="mt-3 text-4xl font-semibold tracking-normal text-balance">
            Create an account without losing your edit.
          </h1>
          <p className="mt-4 text-base leading-7 text-muted-foreground">
            Your workspace can stay focused on timing, transcript cleanup, and the final audio export.
          </p>
        </div>
